...
class _StudentEventState extends State<StudentEvent> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text("Events", style: TextStyle(fontFamily: 'Narrow', fontSize: 30), textAlign: TextAlign.center),
        actions: [
          IconButton(
      ...
      body: Padding(padding: const EdgeInsets.all(15), child: Event(data.isStudent, grid: grid)),
    );
  }
}
